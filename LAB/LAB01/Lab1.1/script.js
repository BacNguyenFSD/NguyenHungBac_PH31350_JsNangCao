...
const players1Final = ['Thiago', 'Coutinho', 'Perisic', ...allPlayers];
...
function printGoals(...playerScored) {
    ...
    console.log(`${playerScored.length} player were scored`);
}
printGoals(...game.scored);

// 7. The team with the lower odd is more likely to win. Print to the 
// console which team is more likely to win, WITHOUT using an if/else statement or the ternary operator.
game.odds.team1 < game.odds.team2 && console.log(`${game.team1} has more chance to win`);
game.odds.team2 < game.odds.team1 && console.log(`${game.team2} has more chance to win`);
